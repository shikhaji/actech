class CompanyProfileModel {
  int? status;
  String? message;
  CompanyProfileList? cOMPANY;

  CompanyProfileModel({this.status, this.message, this.cOMPANY});

  CompanyProfileModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    cOMPANY =
    json['COMPANY'] != null ? new CompanyProfileList.fromJson(json['COMPANY']) : null;
  }
...
class CompanyProfileList {
  ...
  CompanyProfileList.fromJson(Map<String, dynamic> json) {
